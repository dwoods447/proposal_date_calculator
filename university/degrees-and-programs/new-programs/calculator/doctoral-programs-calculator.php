                    ...
                    <div class="col-lg-6 col-xs-12" id="bottom">
                     ...
                     <div class="col-lg-6 col-xs-12">
                            ...
                            <li class="list-group-item"><h3>Total Duration in Days: &nbsp;<span v-if="totalDays != 0"><strong>{{ totalDays }}</strong></span></h3></li>
                                ...
                                <!-- <li class="list-group-item"><h3>Total Duration in Years: &nbsp;<span v-if="totalYears != 0"><strong>{{ totalYears }}</strong></span></h3></li> -->
                            </ul>
                    </div>
            </div>
        </div>
...
<script src="../../../../_js/doctoral-programs-calculator.js"></script>