          ...
          return {
              ...
              proposal: {
                stages: [
                    ...
                    {stage: "UC/GPSC", submission_date: '...', duration: 60, date_of_completion: '...', notes: 'Monthly - Summer Hiatus June - Aug'},
                ...
                if(!isBeforeToday){
                    for(let i = 0; i < stages.length; i++){
                        if(i < 1){
                            ...
                            if(this.isOnAHiatus(monthIndex) && stages[i]['stage'] === "UC/GPSC"){
